...
O sistema DEVE aplicar automaticamente a máscara `XX.XXX.XXX/XXXX-XX` conforme o usuário digita em qualquer campo de CNPJ nos formulários do frontend.
...
O sistema DEVE formatar automaticamente o valor digitado no campo de preço dos planos como moeda brasileira (R$), com separador de milhar e duas casas decimais.
