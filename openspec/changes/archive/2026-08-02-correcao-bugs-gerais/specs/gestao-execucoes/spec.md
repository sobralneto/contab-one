...
Na visão admin da tela de execuções, o sistema DEVE agrupar as execuções por escritório e permitir expandir cada grupo para ver o detalhamento.
...
Na visão escritório da tela de execuções, o sistema DEVE exibir métricas agregadas por cliente.
