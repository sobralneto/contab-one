...
O sistema DEVE exibir no eixo X do gráfico de notas por mês o nome da entidade relevante conforme o papel do usuário logado, e NÃO a data.
...
O sistema DEVE agregar todos os dados exibidos no dashboard conforme o papel do usuário: admin visualiza dados por escritório, escritório e usuário visualizam dados por cliente.
...
Na visão admin do dashboard, o sistema DEVE oferecer um filtro por escritório (em vez de por cliente) que restringe os dados do gráfico.
...
Na visão admin do dashboard, o sistema DEVE exibir o ranking agregado por escritório, com os escritórios ordenados pelo total de notas.
