...
O sistema DEVE permitir que um usuário cadastre um novo cliente com sucesso, persistindo todos os campos do formulário.
...
Na listagem de clientes da visão admin, o sistema DEVE exibir uma coluna com o nome do escritório responsável por cada cliente.
...
Na visão admin da tela de clientes, o sistema DEVE oferecer um filtro para selecionar um escritório específico e filtrar a listagem.
...
Na visão escritório da tela de clientes, o sistema DEVE oferecer um controle de dias para filtrar clientes cujo certificado digital vencerá dentro do período selecionado (1, 2, 3, 7 ou 15 dias).
