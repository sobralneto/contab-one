# tipos-de-arquivo Specification

## Purpose

Define o cadastro de tipos de arquivo do escritório — o vocabulário com que ele
classifica seus documentos. É cadastro do próprio escritório, e não um enum fixo
no código, porque a lista que faz sentido varia de escritório para escritório.
Cobre o CRUD, a unicidade do nome dentro do escritório, o estado ativo/inativo e
a proteção do tipo já em uso contra exclusão.
