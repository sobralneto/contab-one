# escritorio-em-foco Specification

## Purpose

A sessão tem sempre um único escritório em foco — aquele que ela está enxergando agora. Define como o foco é escolhido no login, trocado durante a sessão, validado contra os vínculos a cada emissão e apresentado ao usuário na barra superior.
