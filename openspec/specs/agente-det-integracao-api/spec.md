...
autenticação como agente do produto DET, vínculo das mensagens ao `Cliente`
por CNPJ, substituição do CSV local pelo relatório enviado à API, e a mesma
fila de pendências com reenvio usada por qualquer outro agente.
