...
Na visão admin da tela de agentes, ao clicar em "Nova Chave", o sistema DEVE (MUST) abrir um modal para que o admin selecione o escritório ao qual a chave será vinculada antes de gerá-la.
...
Na visão admin da tela de agentes, o sistema DEVE (MUST) exibir o nome do escritório associado a cada agente na tabela.
...
A tabela de agentes DEVE (MUST) exibir a data de criação de cada chave, com a listagem ordenada da chave mais recente para a mais antiga.
