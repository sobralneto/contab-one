...
configuração local do agente (`Nfse.Agent`), e como a senha do certificado é
resolvida — para que a plataforma nunca precise custodiar segredos que só
fazem sentido na máquina do escritório.
